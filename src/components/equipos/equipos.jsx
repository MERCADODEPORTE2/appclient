...
import river from "../../assets/logoriver.webp";
import seleccion from "../../assets/logoseleccion.webp";
import miami from "../../assets/logoMiami.svg";
import boca from "../../assets/logoBoca.webp";
import independiente from "../../assets/logoIndependiente.webp";
// import racing from "../../assets/logoRacing.webp";
import racing from "../../assets/logoracing.webp";
    ...
    <div className={styles.equipment}>
      ...
      <div className={styles.teams}>
        <div className={styles.team}>
          <a href="/productos-deportivos/River Plate">
            <img src={river} alt="river" loading="lazy" />
          </a>
        </div>
        <div className={styles.line}>.</div>
        <div className={styles.team}>
          <a href="/productos-deportivos/Selección ARG">
            <img src={seleccion} alt="afa" loading="lazy" />
          </a>
        </div>
        <div className={styles.line}>.</div>
        <div className={styles.team}>
          <a href="/productos-deportivos/Inter">
            <img src={miami} alt="inter" loading="lazy" />
          </a>
        </div>
        <div className={styles.line}>.</div>
        <div className={styles.team}>
          <a href="/productos-deportivos/Boca Juniors">
            <img src={boca} alt="boca" loading="lazy" />
          </a>
        </div>
        <div className={styles.line}>.</div>
        <div className={styles.team}>
          <a href="/productos-deportivos/Independiente">
            <img src={independiente} alt="inter" loading="lazy" />
          </a>
        </div>
        <div className={styles.line}>.</div>
        <div className={styles.team}>
          <a href="/productos-deportivos/Racing">
            <img src={racing} alt="inter" loading="lazy" />
          </a>
        </div>
      </div>
      <svg
